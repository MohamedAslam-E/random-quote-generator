 ...
 localQuotes = [
  ...
  //check quote length to apply style
  if(quote.text.length > 40){
    quotechange.classList.add('long-quote');
  }else {
    quotechange.classList.add('long-quote');
  }
  quotechange.textContent = quote.text;
  //return quote;
...
//Tweeet quote
const tweetQuote=()=>{
const twitterUrl = `https://twitter.com/intent/tweet?text=${quotechange.textContent} - ${authorText.textContent}`
